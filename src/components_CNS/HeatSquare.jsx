...
class HeatSquare extends Component {
    ...
    drawHeatSquare(container, count = null, distribution = null, line_domains = {}) {
        ...
        var colorScale = d3.scaleQuantize().domain([0, 60]).range(["#FDEBEB", "#F8DADA", "#F2BFBF", "#F2B1B1", "#F09C9C", "#E78A8A"])  // brighter red
        ...
        var colorScale = d3.scaleQuantize().domain([0, 60]).range(["#DEEDF3", "#C6DFE7", "#B0D4DF", "#96C7D7", "#7DBCD0", "#6EAFC4"])  // light fade blue
        ...
        for (var i = 0; i < data2.length; i++) {
            ...
            if (lineData.length) {
                ...
                if (min === 1.4 || min === 0.1) { max_offset = 10; min_offset = 5; }
                if (min === 2.4) { max_offset = 11; min_offset = 5; }
                if (max === 170.5) max_offset = 5;
        ...
        var colorScale = d3.scaleQuantize().domain([0, 420]).range(["#E5E5F8", "#DADAF2", "#D3D3EB", "#C7C7E2", "#BCBCDC", "#AEAED3"])  // light purple
        ...
        for (var i = 0; i < data3.length; i++) {
            ...
            if (lineData.length) {
                ...
                let x_offset = 7;
                if (max === 11) x_offset = 9;
                if (max === 2) x_offset = 10;
